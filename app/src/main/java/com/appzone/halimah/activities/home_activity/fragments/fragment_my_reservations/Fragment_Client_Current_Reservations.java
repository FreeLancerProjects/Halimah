...
public class Fragment_Client_Current_Reservations extends Fragment {
    ...
    public static Fragment_Client_Current_Reservations getInstance(UserModel userModel)
    {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,userModel);
        Fragment_Client_Current_Reservations fragment_client_current_reservations = new Fragment_Client_Current_Reservations();
        fragment_client_current_reservations.setArguments(bundle);
        return fragment_client_current_reservations;
    }
    ...
    private void getData(String user_id) {
        Api.getService()
                .getClientCurrentReservations(user_id)
