...
public class Fragment_Client_New_Reservations extends Fragment {
    ...
    public static Fragment_Client_New_Reservations getInstance(UserModel userModel)
    {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,userModel);
        Fragment_Client_New_Reservations fragment_client_new_reservations = new Fragment_Client_New_Reservations();
        fragment_client_new_reservations.setArguments(bundle);
        return fragment_client_new_reservations;
    }
    ...
    private void getData(String user_id) {
        Api.getService()
                .getClientNewReservations(user_id)
