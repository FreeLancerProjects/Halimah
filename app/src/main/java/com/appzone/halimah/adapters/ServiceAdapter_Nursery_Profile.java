...
public class ServiceAdapter_Nursery_Profile extends RecyclerView.Adapter<ServiceAdapter_Nursery_Profile.MyHolder>{

    private Context context;
    private Fragment fragment;
    private List<ServiceModel> serviceModelList;
    private SparseBooleanArray sparseBooleanArray;
    public ServiceAdapter_Nursery_Profile(Context context, Fragment fragment, List<ServiceModel> serviceModelList) {
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.checkBox.isChecked())
                {
                    ...
                    if (fragment instanceof Fragment_Profile_Nursery)
                    {
                        Fragment_Profile_Nursery fragment_profile_nursery = (Fragment_Profile_Nursery) fragment;
                        fragment_profile_nursery.setItem(serviceModel);
                    }
                ...
                }else
                {
                    ...
                    {
                        Fragment_Profile_Nursery fragment_profile_nursery = (Fragment_Profile_Nursery) fragment;
                        fragment_profile_nursery.removeItem(serviceModel);
                    }
