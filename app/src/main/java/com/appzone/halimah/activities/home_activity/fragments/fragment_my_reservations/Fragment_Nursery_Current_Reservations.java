...
public class Fragment_Nursery_Current_Reservations extends Fragment {
    ...
    public static Fragment_Nursery_Current_Reservations getInstance(UserModel userModel)
    {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,userModel);
        Fragment_Nursery_Current_Reservations fragment_nursery_current_reservations = new Fragment_Nursery_Current_Reservations();
        fragment_nursery_current_reservations.setArguments(bundle);
        return fragment_nursery_current_reservations;
    }
    ...
    {
        Api.getService()
                .getNurseryCurrentReservations(user_id)
